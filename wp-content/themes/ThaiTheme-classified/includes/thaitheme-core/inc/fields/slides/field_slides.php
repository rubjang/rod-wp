        ...
        public function render () {
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
					...
					if ( $this->field[ 'show' ][ 'title2' ] ) {
                        $title_type = "text";
                    } else {
                        $title_type = "hidden";
                    }
					$placeholder = ( isset ( $this->field[ 'placeholder' ][ 'title2' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'title2' ] ) : __ ( 'Title2', 'redux-framework' );
                    echo '<li><input type="' . $title_type . '" id="' . $this->field[ 'id' ] . '-title2_' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][title2]' . $this->field['name_suffix'] . '" value="' . esc_attr ( $slide[ 'title2' ] ) . '" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';
					
					if ( $this->field[ 'show' ][ 'title3' ] ) {
                        $title_type = "text";
                    } else {
                        $title_type = "hidden";
                    }
					$placeholder = ( isset ( $this->field[ 'placeholder' ][ 'title3' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'title3' ] ) : __ ( 'Title3', 'redux-framework' );
                    echo '<li><input type="' . $title_type . '" id="' . $this->field[ 'id' ] . '-title3_' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][title3]' . $this->field['name_suffix'] . '" value="' . esc_attr ( $slide[ 'title3' ] ) . '" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';
					
					if ( $this->field[ 'show' ][ 'title4' ] ) {
                        $title_type = "text";
                    } else {
                        $title_type = "hidden";
                    }
					$placeholder = ( isset ( $this->field[ 'placeholder' ][ 'title4' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'title4' ] ) : __ ( 'Title4', 'redux-framework' );
                    echo '<li><input type="' . $title_type . '" id="' . $this->field[ 'id' ] . '-title4_' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][title4]' . $this->field['name_suffix'] . '" value="' . esc_attr ( $slide[ 'title4' ] ) . '" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';
            ...
            if ( $x == 0 ) {
                ...
                $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'title2' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'title2' ] ) : __ ( 'Title2', 'redux-framework' );
                echo '<li><input type="' . $title_type . '" id="' . $this->field[ 'id' ] . '-title2_' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][title2]' . $this->field['name_suffix'] .'" value="" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';
                ...
                $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'title3' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'title3' ] ) : __ ( 'Title3', 'redux-framework' );
                echo '<li><input type="' . $title_type . '" id="' . $this->field[ 'id' ] . '-title3_' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][title3]' . $this->field['name_suffix'] .'" value="" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';
                ...
                $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'title4' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'title4' ] ) : __ ( 'Title4', 'redux-framework' );
                echo '<li><input type="' . $title_type . '" id="' . $this->field[ 'id' ] . '-title4_' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][title4]' . $this->field['name_suffix'] .'" value="" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';
            ...
            echo '</div><a href="javascript:void(0);" class="button redux-slides-add button-primary" rel-id="' . $this->field[ 'id' ] . '-ul" rel-name="' . $this->field[ 'name' ] . '[title][]' . $this->field['name_suffix'] .'">' . sprintf ( __ ( '+ เพิ่ม', 'redux-framework' ), $this->field[ 'content_title' ] ) . '</a><br/>';
        }
