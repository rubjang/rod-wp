    ...
    if ( ! class_exists( 'ReduxFramework_import_export' ) ) {
        ...
        class ReduxFramework_import_export extends ReduxFramework {
            ...
            public function render() {
                ...
                <p class="description"><?php echo apply_filters( 'redux-backup-description', __( 'สามารถ Download การตั้งค่า Theme Option ได้ที่นี่ ลูกค้าควร Backup ข้อมูลไว้ทุกครั้งหากมีการตั้งค่า Theme Option ใหม่เพื่อป้องกันข้อมูลการตั้งค่าต่างๆภายใน Theme สูญหาย ( หากมีข้อสงสัยเกี่ยวกับการใช้งานสามรถติดต่อได้ที่
<a href="http://www.thaitheme.com" target="_blank" title="รับทำเว็บไซต์"> www.ThaiTheme.com </a>', 'redux-framework' ) ) ?></p>
                </div>
                <?php
