<div class="tt-sec">
  <div class="tt-title-sec">
    <h2>
        <a title="<?php global $thaitheme_option;  echo $thaitheme_option['thaitheme_title_ct2']; ?>" href="<?php global $thaitheme_option;  echo $thaitheme_option['thaitheme_url_ct2']; ?>">
        <?php global $thaitheme_option;  echo $thaitheme_option['thaitheme_title_ct2']; ?>
      </a>
    </h2>
    </div>
    ...
    <div class="tt-img">
    <?php thaitheme_postimage(350,200); /* ขนาดกว้าง x ยาว ของรูปภาพ */?>
