...
<h1><span class="red">คุณกำลังแก้ไข </span>" <?php esc_html_e( get_post( $post_id )->post_title ) ?> "</h1>
</div>
<div class="thaitheme_read">
 <div class="tt_btn_post top">
  <div class="tt_post edit">
    <a href="<?php esc_attr_e(get_the_permalink()) ?>" class="adverts-button"><?php _e("ประกาศทั้งหมด", "adverts") ?></a>
    <a href="<?php esc_attr_e(get_post_permalink( $post_id )) ?>" class="adverts-button"><?php _e("ดูประกาศนี้", "adverts") ?></a>
	</div>
</div>
 ...
 <div class="adverts-control-group <?php esc_attr_e( str_replace("_", "-", $field["type"] ) ) ?> <?php if(adverts_field_has_errors($field)): ?>adverts-field-error<?php endif; ?>"> 
        ...
        <?php endforeach; ?>
         <div class="tt_btn_post">
            <input type="submit" name="submit" value="<?php _e("อัพเดทประกาศ", "adverts") ?>" class="adverts-cancel-unload" />
        </div>
</form>
</div>
</div>
