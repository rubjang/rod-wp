...
<ul class="steps">
  <li class="past">
    <span>
     ...
     <strong class="steps_f">กรอกรายละเอียด</strong>
    </span><i></i>
  </li>
  <li class="present">
    <span>
      <strong class="steps_h">ขั้นตอนที่ 2</strong>
      <strong class="steps_f">ลงประกาศ</strong>
    </span><i></i>
  </li>
</ul>
</div>
...
<form action="" method="post" class="adverts-form adverts-form-aligned">
        ...
        <div class="adverts-control-group <?php esc_attr_e( str_replace("_", "-", $field["type"] ) ) ?>
          <?php if(adverts_field_has_errors($field)): ?>adverts-field-error<?php endif; ?>">
