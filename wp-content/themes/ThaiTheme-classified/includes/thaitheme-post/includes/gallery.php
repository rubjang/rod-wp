...
function adverts_gallery_content( $post = null, $conf = array() ) {
    ...
    <div id="adverts-plupload-upload-ui">
        <div id="adverts-drag-drop-area" class="adverts-gallery">
            <p><a href="#" id="adverts-plupload-browse-button" class="button-secondary"><?php _e( "คลิกเลือกรูปภาพ", "adverts" ) ?></a></p>
			<span class="tt_error_up">อัพโหลดได้สูงสุด 10 รูป</span>
        </div>
        <div class="adverts-gallery-uploads"></div>
    </div>
    <div id="adverts-modal-gallery" class="adverts-modal">
        <div class="media-modal wp-core-ui">
            <a class="media-modal-close adverts-upload-modal-close" href="#" title="<?php _e( "ปิด", "adverts" ) ?>"><span class="media-modal-icon"></span></a>
            <div class="media-modal-content">
                <div class="media-frame wp-core-ui2 hide-menu">
                    <div class="media-frame-title"><h1><?php _e( "ตั้งค่ารูปนี้", "adverts" ) ?></h1></div>
                    <div class="media-frame-router">
                        <div class="media-router">
                            <a href="#" class="media-menu-item active"><?php _e( "ภาพคุณสมบัติ", "adverts" ) ?></a>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <label for="adverts_featured">
                                                    ...
                                                    <?php esc_attr_e( "ใช้รูปนี้เป็น รูปหัวข้อประกาศ", "adverts") ?>
                                                </label>
                                            </td>
                                        </tr>                   
                                    </tbody>
                    ...
                    <div class="media-frame-toolbar">
                        <div class="media-toolbar">
                            ...
                            <div class="media-toolbar-primary">
                                ...
                                <a href="#" class="button media-button button-secondary button-large media-button-select adverts-upload-modal-close"><?php _e( "ยกเลิก", "adverts" ) ?></a>
                                <a href="#" class="button media-button button-primary button-large media-button-select adverts-upload-modal-update"><?php _e( "บันทึก", "adverts" ) ?></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    ?>
    <div id="adverts-plupload-upload-ui">
        <div id="<?php echo ($iPhone || $iPad) ? 'adverts-drag-drop-disabled' : 'adverts-drag-drop-area' ?>" class="adverts-gallery">
            <p><a href="#" id="adverts-plupload-browse-button" class="adverts-button"><?php _e( "คลิกเลือกรูปภาพ", "adverts" ) ?></a></p>
			<span class="tt_error_up">อัพโหลดได้สูงสุด 10 รูป</span>
        </div>
        <div class="adverts-gallery-uploads"></div>
    </div>
            ...
            <form action="" method="post" class="adverts-form adverts-form-aligned">
                <fieldset>
                    <div class="adverts-control-group">
                        ...
                        <?php esc_html_e( "ใช้รูปนี้เป็น รูปหัวข้อประกาศ", "adverts") ?>
                    </div>
                </fieldset>
            </form>
            <div>
                <a href="#" class="adverts-button adverts-upload-modal-close"><?php _e( "ยกเลิก" ) ?></a>
                <a href="#" class="adverts-button adverts-upload-modal-update"><?php _e( "บันทึก" ) ?></a>
