<?php $urlpath = $_SERVER['HTTP_HOST']."".$_SERVER["REQUEST_URI"]; //echo $urlpath; 
	$image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'single-post-thumbnail' ); // image show social
 ?>
...
<?php if($test_title!=""){?>
<title><?php trim(wp_title('')); ?><?php if(wp_title('', false)) { echo ' :'; } ?> <?php trim(bloginfo('name')); ?></title>
<meta name="keywords" content="รถรับจ้าง,รถกระบะรับจ้าง,รถรับจ้างทั่วไป,รถบรรทุกรับจ้าง,รถหกล้อรับจ้าง,รถ6ล้อรับจ้าง" />
<meta name="description" content="บริการ<?php trim(wp_title('')); ?><?php if(wp_title('', false)) { echo ' :'; } ?> <?php trim(bloginfo('name')); ?> ทั่วทั้งประเทศ บริการ 24 ชั่วโมง" /><? } ?>
...
<meta itemprop="headline" content="<?php trim(wp_title('')); ?><?php if(wp_title('', false)) { echo ' :'; } ?> <?php trim(bloginfo('name')); ?>" />
<meta itemprop="name" content="<?php trim(wp_title('')); ?><?php if(wp_title('', false)) { echo ' :'; } ?> <?php trim(bloginfo('name')); ?>" />
<meta itemprop="description" content="บริการ<?php trim(wp_title('')); ?><?php if(wp_title('', false)) { echo ' :'; } ?> <?php trim(bloginfo('name')); ?> ทั่วทั้งประเทศ บริการ 24 ชั่วโมง" />
<meta itemprop="image" content="<?php echo $image[0]; ?>" /> <!-- ต้องใส่ -->
...
<meta property="og:title" content="<?php trim(wp_title('')); ?><?php if(wp_title('', false)) { echo ' :'; } ?> <?php trim(bloginfo('name')); ?>" />
<meta property="og:description" content="บริการ<?php trim(wp_title('')); ?><?php if(wp_title('', false)) { echo ' :'; } ?> <?php trim(bloginfo('name')); ?> ทั่วทั้งประเทศ บริการ 24 ชั่วโมง"/>
<meta property="og:image" content="<?php echo $image[0]; ?>" /><!-- ต้องใส่ -->
<meta property="og:url" content="<?php echo $urlpath;?>"/>
<!-- End Social Open Graph Facebook  -->
<? } ?>
</head> 
<body <?php body_class(); ?>>
<h1 style="display:none">รถรับจ้าง บริการรถรับจ้างราคาถูก รถรับจ้างกรุงเทพ และ ต่างจังหวัด</h1>
<div class="tt_head_content">
<div class="tt_head_top sb-slide">
<div class="tt_main">
<div class="tt_ct_menu">
<a class="tt_list_menu del" title="แจ้งลบประกาศ" href="<?php global $thaitheme_option; echo $thaitheme_option['thaitheme_menu_del'];  ?>"> แจ้งลบประกาศ</a> 
<a class="tt_list_menu help" title="คู่มือลงประกาศ" href="<?php global $thaitheme_option; echo $thaitheme_option['thaitheme_menu_help'];  ?>"> คู่มือลงประกาศ</a> 
<a class="tt_list_menu contact" title="ติดต่อเรา" href="<?php global $thaitheme_option; echo $thaitheme_option['thaitheme_menu_contact'];  ?>"> ติดต่อเรา</a> 
</div>
