...
<div class="tt_main">
<span><span class="tt_web"><?php echo $_SERVER['SERVER_NAME']; ?></span> © <?php echo date('Y'); ?> All Right Reserved.  Designed by<a href="https://www.thaitheme.com" title="รับทำเว็บไซต์" target="_blank"> ThaiTheme.com</a></span>
</div>
</div>
</div>
</div>
