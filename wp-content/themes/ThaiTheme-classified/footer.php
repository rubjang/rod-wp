...
<a href="<?php global $thaitheme_option;  echo $thaitheme_option['thaitheme_url_banner_footer']; ?>"  target="_blank"><img alt="" src="<?php global $thaitheme_option;  echo $thaitheme_option['thaitheme_uppic_banner_footer']['url']; ?>?v=1.0"></a>
<?php }?>
<?php global $thaitheme_option;  $thaitheme_use_banner_footer =  $thaitheme_option['thaitheme_use_banner_footer'];
...
<div class="tt_main">
<span>
<span class="tt_web_NO">
<!-- 	<?php echo $_SERVER['SERVER_NAME']; ?></span> © <?php echo date('Y'); ?> All Right Reserved.  Designed by<a href="https://www.thaitheme.com" title="รับทำเว็บไซต์" target="_blank"> ThaiTheme.com</a> -->
	สงวนสิขสิทธิ์ <a href="http://www.rodrubjang.com">www.rodrubjang.com</a> © 2016 ตามกฎหมาย ห้ามนำข้อมูลทุกอย่างที่มีบนเว็บไซต์ไปเผยแพร่ ทำซ้ำ ดัดแปลงหรือวิธีการอื่นใดโดยมิได้รับอนุญาต เป็นรายลักษณ์อักษรจากผู้ดูแลเว็บไซต์
	</span>
</div>
</div>
</div>
