<?php
	...
	add_action( 'wp_ajax_dpsp_activate_location', 'dpsp_activate_location' );
	 ...
	 *
	 */
	function dpsp_deactivate_location() {
	...
	add_action( 'wp_ajax_dpsp_deactivate_location', 'dpsp_deactivate_location' );
