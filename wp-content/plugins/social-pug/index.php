...
Class Social_Pug {
	...
	public function init_admin_scripts( $hook ) {
		...
		if( strpos( $hook, 'dpsp' ) !== false ) {
			wp_register_script( 'select2-js', 'http://cdnjs.cloudflare.com/ajax/libs/select2/4.0.1/js/select2.min.js', array( 'jquery' ) );
			wp_enqueue_script( 'select2-js' );

			wp_register_style( 'select2-css', 'http://cdnjs.cloudflare.com/ajax/libs/select2/4.0.1/css/select2.min.css' );
